...
function Resourceusage(Resourceusage) {
    ...
    Resourceusage.getCPUUsage = async function (pod_name, start_time, end_time){

    };

    Resourceusage.getResourceUsage = async function (pod_name, resource_type, start_time, end_time) {
